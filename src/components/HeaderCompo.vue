...
<style scoped>
/*Header links' backgrounds change when hovering over them.*/
.nav li a:hover {
  background-color: #b0b0b0;
  border-radius: 5px;
}

/*Header links have more padding.*/
.nav li a {
  padding: 10px 15px;
}
...
.header {
  ...
  /*Items in header box are in a row, stretched to the width of the screen.*/
  display: flex;
  flex-direction: row;
  align-items: center;
